...
impl Range {
    ...
    pub(crate) fn between(v1: impl Into<Version>, v2: impl Into<Version>) -> Self {
        Self(R::between(v1, v2))
    }

    pub(crate) fn from_range_bounds<RB>(bounds: RB) -> Self
    where
        RB: RangeBounds<Version>,
    {
        Self(R::from_range_bounds(bounds))
    }
